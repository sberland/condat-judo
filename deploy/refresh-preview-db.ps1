...
$DropSql   = "DROP TABLE IF EXISTS paiement_parts; DROP TABLE IF EXISTS paiements; DROP TABLE IF EXISTS inscriptions_competition; DROP TABLE IF EXISTS competitions; DROP TABLE IF EXISTS adhesions; DROP TABLE IF EXISTS sessions; DROP TABLE IF EXISTS liens_connexion; DROP TABLE IF EXISTS liens; DROP TABLE IF EXISTS personnes_autorisees; DROP TABLE IF EXISTS identites; DROP TABLE IF EXISTS user_roles; DROP TABLE IF EXISTS adherents; DROP TABLE IF EXISTS saisons; DROP TABLE IF EXISTS users; DROP TABLE IF EXISTS d1_migrations;"
