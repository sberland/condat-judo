...
Liste codée en dur (ordre = dépendances FK) : `paiement_parts`, `paiements`, `inscriptions_competition`, `competitions`, `adhesions`, `sessions`, `liens_connexion`, `liens`, `personnes_autorisees`, `identites`, `user_roles`, `adherents`, `saisons`, `users`, `d1_migrations`.
