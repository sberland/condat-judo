...
| Fichier | Contenu |
| --- | --- |
| [`registre-traitements.md`](rgpd/registre-traitements.md) | Registre des traitements (art. 30 RGPD) : adhésions, compétitions, consentements, espace membres, sauvegardes — finalités, bases légales, données, destinataires, durées, sécurité. À valider par le bureau ; même contenu que la page « Données personnelles » du site |
