...
| [012-CHT-garderie-mercredi.md](pending/012-CHT-garderie-mercredi.md) | Garderie | feature | Élevé — remplace un fil WhatsApp confus | M | P2 | — | Chantier (a=demande — livrée en v0.13.0, b=liste du jour + photo — livrée en v0.14.0, c=pointage) |
...
| 3 — Le club autonome | ~~003~~ (v0.12.0, en qualif) → **014** | Référentiels en base (saison 2027/2028) et contenu du site administrés par le club |
| 4 — Valeur pour les familles | ~~009~~ (v0.9.0, en qualif) puis **012-CHT** (012a en v0.13.0, 012b en v0.14.0, en qualif) | Besoin d'origine d'abord ; la garderie ensuite (hebdomadaire) |
