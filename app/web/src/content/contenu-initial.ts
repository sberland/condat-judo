// Contenu initial du site (spec 014) : repris de l'ancien content/club.ts (textes du club sur son
// ancien site, règlement mis à jour en septembre 2026). La migration 0012 le copie en base ; le
// site l'affiche en repli tant que l'API n'a pas répondu (ou si elle est injoignable).
// ⚠️ Dépôt public : n'ajouter ici que des informations que le club publie déjà.
import type { CleContenu, Contenus, StatutContenu } from './contenu'

export const CONTENU_INITIAL: Contenus = {
  contact: {
  ...
  // Règlement intérieur mis à jour selon la réglementation France Judo en vigueur (septembre 2026) :
  // formalités médicales (décret n° 2021-564 du 7 mai 2021) et contrôle d'identité en compétition.
  reglement: {
...
/** Contenus encore à confirmer par le club au départ : les coordonnées (e-mail, téléphone). */
export const STATUTS_INITIAUX: Record<CleContenu, StatutContenu> = {
  contact: 'a_completer',
  club: 'publie',
  association: 'publie',
  equipe: 'publie',
