...
export function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-40 border-b bg-white/85 backdrop-blur-md transition-shadow ${defile ? 'shadow-sm' : 'border-transparent'}`}
    >
      ...
      <div
        id="menu-mobile"
        className={`fixed inset-x-0 top-16 bottom-0 bg-white transition-all duration-200 md:hidden ${
